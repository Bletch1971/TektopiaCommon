...
public class EntityAILeaveVillage extends EntityAIMoveToBlock {
    ...
    public EntityAILeaveVillage(EntityVillagerTek entity, Predicate<EntityVillagerTek> shouldPred, Function<EntityVillagerTek, BlockPos> whereFunc, MovementMode moveMode, Runnable startRunner, Runnable resetRunner) {
        super(entity);
        this.entity = entity;
